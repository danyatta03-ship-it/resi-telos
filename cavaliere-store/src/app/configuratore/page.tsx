...
import { pricing, configuratorOptions } from "@/content/site";
...
export default function ConfiguratorePage() {
  return (
    ...
    >
      <p>
        Compila il modulo con le tue scelte e i file di riferimento: ti
        ricontatteremo su Instagram o via email per confermare i dettagli, il
        totale finale e i tempi di realizzazione.
      </p>
